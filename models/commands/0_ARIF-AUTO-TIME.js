...
module.exports.config = {
  name: 'AUTO-TIME',
  version: '14.0.1', // Incremented version
  hasPermssion: 0,
  credits: 'ARIF BABU',
  description: 'Stylish Auto Time & Date Sender (Karachi Time)',
...
module.exports.onLoad = () => {
  console.log(
    chalk.bold.green("====== STYLISH AUTO TIME SYSTEM LOADED (KARACHI) ======")
  );
