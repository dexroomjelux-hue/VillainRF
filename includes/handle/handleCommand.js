Module.exports = function ({ api, models, Users, Threads, Currencies }) {
  ...
  return async function ({ event }) {
    ...
    // --- START: IGNORE ALL SYSTEM ---
    const threadSettingIgnore = (await Threads.getData(threadID)) || {};
    if (threadSettingIgnore.ignoreAll === true) {
        if (!global.config.ADMINBOT.includes(senderID)) {
            return; // Agar ignore ON hai aur user Admin nahi hai, toh kuch mat karo
        }
    }
    // --- END: IGNORE ALL SYSTEM ---
